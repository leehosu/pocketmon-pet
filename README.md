...
- 기술 이펙트 타일은 [pret/pokegold](https://github.com/pret/pokegold)의 배틀 애니메이션
  그래픽을 사용한다. 기술 검수 갤러리에는 PokéAPI Gold 스프라이트 12개와 해당 타일을 포함한다.
...
기기에 캐시하며, 기술 검수용 Gold 스프라이트와 배틀 애니메이션 타일은 출처를 명시해 포함한다. 권리자의 요청이 있으면 즉시 관련
기능을 제거한다.
